...
const bookList = [
  ...
  */
  ...
  const newItem = {title: "Ender's Game", author: "Orson Scott Card"};
  ...
  const displayBooks = () => {
    Object.values(bookList).forEach((book) => console.log(book.title));
  }
//   displayBooks();
  ...
  /* (4) Write a one-line arrow function that takes in a number and returns a string stating whether the
    ...
    const displayPositivity = (num) => {
        const positivity = num > 0 ? "positive" : "negative";
        return positivity
    }

    // console.log(displayPositivity(0))
